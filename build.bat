...
set MSVC_CXXFLAGS_DEBUG=/DBOOST_ALL_NO_LIB /EHsc /Zi /Od /MDd /std:c++17 /DBOOST_CONFIG_SUPPRESS_OUTDATED_MESSAGE
set MSVC_CXXFLAGS_RELEASE=/DBOOST_ALL_NO_LIB /EHsc /Zi /O2 /MD /std:c++17 /DBOOST_CONFIG_SUPPRESS_OUTDATED_MESSAGE
set MSVC_LINKFLAGS_DEBUG=/link %MSVC_LIBS%
set MSVC_LINKFLAGS_RELEASE=/link %MSVC_LIBS%

set GCC_CXXFLAGS_DEBUG=%GCC_INCLUDE_PATHS% -O0 -g -std=c++17
set GCC_CXXFLAGS_RELEASE=%GCC_INCLUDE_PATHS% -O2 -std=c++17
